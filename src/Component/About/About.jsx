      ...
      <div>
        <div className='my-10'>
          ...
          <div className='lg:flex gap-5'>
                ...
                <div>
                  ...
                  <ul className='flex flex-col gap-5'>
                    ...
                    <li className='text-[15px] md:text-[18px] flex gap-2'>
                      ...
                      <span>01330961124</span>
                    </li>
                    <li className='text-[15px] md:text-[18px] flex flex-wrap gap-2'>
                      <p className='opacity-100 font-extrabold '>Email:</p>
                      <span>mdhabibulla146425@gmail.com</span>
                    </li>
                    <li className='text-[15px] md:text-[18px] flex gap-2'>
            ...
            <div className='flex flex-wrap justify-between w-[90%] lg:w-[45%] mx-auto gap-2 mt-5'>
              {pInfo.map((item, id) => {
                return (
                  <div key={id} className='px-5 py-3 border-2 border-orange-400 rounded-xl w-[45%]'>
