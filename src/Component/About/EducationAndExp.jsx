...
const EducationAndExp = () => {
    return (
        <div className='mt-10 py-8'>
            <h2 className='text-2xl font-extrabold font-serif border-b-2 pb-3 w-fit uppercase'>Education & Experience</h2>
            <div className='lg:flex lg:justify-between lg:flex-wrap w-[90%] lg:w-[95%] mx-auto'>
                <div className='lg:w-[48%] '>
                    <h3 className='text-xl font-bold font-sans border-b-2 pb-1 w-fit mb-5'>Education</h3>
                    <div className='pl-8 relative after:absolute after:content-[""] after:w-0.5 after:h-full after:bg-cyan-400 after:left-2 after:top-0'>
                        <div >
                            ...
                            <p className='font-bold  py-1 text-sm'>2020-2025</p>
                            <p className='text-sm py-1 '>Boalmari Institute of Engineering and Technology</p>
                        ...
                        <div className='pt-10'>
                            ...
                            <p className='font-bold  py-1 text-sm uppercase'>jan,20-mar,2020 </p>
                            <p className='text-sm py-1 '>Kharsuti C.K. High</p>
                            <p className='pt-4 text-sm font-medium opacity-90 font-serif '>
                ...
                <div className='lg:w-[48%]'>
                    <h3 className='text-xl font-bold font-sans border-b-2 pb-1 w-fit mb-5'>Professional Experience</h3>
                    <div className='pl-8 relative after:absolute after:content-[""] after:w-0.5 after:h-full after:bg-cyan-400 after:left-2 after:top-0'>
                        <div >
                            ...
                            <p className='font-bold  py-1 text-sm uppercase'>jul,2024-sep,2024</p>
                            <p className='text-sm py-1 '>WIT Institute</p>
                            <p className='pt-4 text-sm font-medium opacity-90 font-serif '>
                        ...
                        <div className='pt-10'>
                            ...
                            <p className='font-bold  py-1 text-sm uppercase'>MAR, 2024 – PRESENT</p>
