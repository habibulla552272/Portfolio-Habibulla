...
const Navebar1 = () => {
    ...
    return (
        <section className={`bg-black text-white fixed top-0 h-[100%] z-50 ${menuBar ? "absolute top-0 left-0 ease-in-out duration-700" : " absolute top-0 -left-60 ease-in-out duration-700"}`}>
            <div className=''>
